 ...
 *//* tslint:disable:no-unused-variable member-ordering */
 ...
 import { SzBoundType } from './models/szBoundType';
 import { SzCrossSourceSummaryResponse } from './models/szCrossSourceSummaryResponse';
 import { SzEntityRelationsBreakdownResponse } from './models/szEntityRelationsBreakdownResponse';
 import { SzEntityRelationsCountResponse } from './models/szEntityRelationsCountResponse';
 import { SzEntitySizeBreakdownResponse } from './models/szEntitySizeBreakdownResponse';
 import { SzEntitySizeCountResponse } from './models/szEntitySizeCountResponse';
 import { SzErrorResponse } from './models/szErrorResponse';
 import { SzLoadedStatsResponse } from './models/szLoadedStatsResponse';
 import { SzMatchCountsResponse } from './models/szMatchCountsResponse';
 import { SzPagedEntitiesResponse } from './models/szPagedEntitiesResponse';
 import { SzPagedRelationsResponse } from './models/szPagedRelationsResponse';
 import { SzRelationCountsResponse } from './models/szRelationCountsResponse';
 import { SzSourceLoadedStatsResponse } from './models/szSourceLoadedStatsResponse';
 import { SzSourceSummaryResponse } from './models/szSourceSummaryResponse';
 import { SzSummaryStatsResponse } from './models/szSummaryStatsResponse';
 
 import { BASE_PATH, COLLECTION_FORMATS }   from './variables';
 import { SzDataMartEnvironment }         from './sz-datamart-environment';
 
 
 @Injectable({
    providedIn: 'root'
 })
 export class SzHttpStatisticsService {
 
     protected basePath = 'http://localhost:8250';
     public defaultHeaders = new HttpHeaders();
     public environment = new SzDataMartEnvironment();
 
     constructor(
        protected httpClient: HttpClient, 
        @Optional()@Inject(BASE_PATH) basePath: string, 
        @Inject('DATAMART_ENVIRONMENT') environment: SzDataMartEnvironment) {
         if (basePath) {
             this.basePath = basePath;
         }
         if (environment) {
             this.environment = environment;
             this.basePath = basePath || environment.basePath || this.basePath;
         }
     }
     ...
     public getAmbiguouslyCrossMatchedEntityIds(dataSourceCode: string, vsDataSourceCode: string, matchKey?: string, principle?: string, bound?: number, boundType?: SzBoundType, pageSize?: number, sampleSize?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
         ...
         const httpHeaderAcceptSelected: string | undefined = this.environment.selectHeaderAccept(httpHeaderAccepts);
         ...
         return this.httpClient.request<SzPagedEntitiesResponse>('get',`${this.basePath}/statistics/summary/data-sources/${encodeURIComponent(String(dataSourceCode))}/vs/${encodeURIComponent(String(vsDataSourceCode))}/ambiguous-matches/entities`,
             {
                 ...
                 withCredentials: this.environment.withCredentials,
                 headers: headers,
                 observe: observe,

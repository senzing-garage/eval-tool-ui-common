...
export class SzGraphComponentGrpc implements OnInit, OnDestroy {
  ...
  */
  ...
  @Input() public set showCoreMatchKeyTokenChips(value: boolean | string){
    ...
    if (value === true) {
      //console.log('@senzing/eval-tool-ui-common/sz-graph-component.showCoreMatchKeyTokenChips = '+ value);
  ...
  @Input() public set showExtraneousMatchKeyTokenChips(value: boolean | string) {
    ...
    if (value === true) {
      //console.log('@senzing/eval-tool-ui-common/sz-graph-component.showExtraneousMatchKeyTokenChips = '+ value);
  ...
  @Input() public set matchKeyTokenSelectionScope(value: SzMatchKeyTokenFilterScope | string){
    ...
    //console.log(`@senzing/eval-tool-ui-common/sz-graph-component.matchKeyTokenSelectionScope(${value} | ${(this._matchKeyTokenSelectionScope as unknown as string)})`, this._matchKeyTokenSelectionScope);
  }
  /**
  ...
  */
  ...
  private onPrefsChange(prefs: SzGraphPrefs) {
    //console.log('@senzing/eval-tool-ui-common/sz-graph-component.onPrefsChange(): ', prefs, this.prefs.graph.toJSONObject());
    ...
    if(
      ...
      /*
      console.warn('@senzing/eval-tool-ui-common/sz-graph-component.onPrefsChange(): query parameter changed!!!',
      this.maxDegrees != prefs.maxDegreesOfSeparation,
  ...
  public canRemoveNode(entityId: SzEntityIdentifier) {
    //console.log(`@senzing/eval-tool-ui-common/sz-graph-component.canRemoveNode: `, entityId);
  ...
  public canExpandNode(entityId: SzEntityIdentifier) {
    //console.log(`@senzing/eval-tool-ui-common/sz-graph-component.canExpandNode: `, entityId);
  ...
  public removeNode(entityId: SzEntityIdentifier) {
    console.log(`@senzing/eval-tool-ui-common/sz-graph-component.removeNode: `, entityId);
  ...
  public collapseNode(entityId: SzEntityIdentifier) {
    console.log(`@senzing/eval-tool-ui-common/sz-graph-component.collapseNode: `, entityId);
  ...
  public expandNode(entityId: SzEntityIdentifier) {
    console.log(`@senzing/eval-tool-ui-common/sz-graph-component.expandNode: `, entityId);

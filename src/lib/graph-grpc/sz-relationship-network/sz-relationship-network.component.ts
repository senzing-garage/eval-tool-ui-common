...
export class SzRelationshipNetworkComponent implements AfterViewInit, OnDestroy {
  ...
  @Input() public set showLinkLabels(value: boolean) {
    ...
    if(value && this.linkLabel) {
      ...
      // console.log('@senzing/eval-tool-ui-common:sz-relationship-network.setShowLinkLabels: ', value, 1);
    } else if(this.linkLabel) {
      this.linkLabel.style("opacity", 0);
      // console.log('@senzing/eval-tool-ui-common:sz-relationship-network.setShowLinkLabels: ', value, 0);
    } else {
      // console.log('@senzing/eval-tool-ui-common:sz-relationship-network.setShowLinkLabels: UNKNOWN!', this._showLinkLabels, this.linkLabel);
    }
    */
  }
...
/*
  ...
  */
  ...
  public render(gdata: SzNetworkGraphInputs) {
    ...
    console.log('@senzing/eval-tool-ui-common/sz-relationship-network.render(): ', gdata, this._filterFn);
  ...
  public reload(entityIds?: SzEntityIdentifier | SzEntityIdentifier[] | Array<string | number>): void {
    ...
    if(this._entityIds) {
      ...
      console.warn('@senzing/eval-tool-ui-common/sz-relationship-network.reload(): ', this._entityIds, _maxEntitiesLimit, this._unlimitedMaxEntities);
  ...
  addSvg(gdata: SzNetworkGraphInputs, parentSelection = d3.select("body")) {
    ...
    //console.log('@senzing/eval-tool-ui-common:sz-relationship-network.addSvg', gdata, graph);

...
import { SzDataMartConfiguration, SzDataMartConfigurationParameters } from './sz-datamart-configuration';
...
export class SzDataMartEnvironment {
   ...
   */
  @Output()
  public parametersChanged: Subject<SzDataMartConfigurationParameters> = new Subject<SzDataMartConfigurationParameters>();
  ...
  public fromParameters(value: SzDataMartConfigurationParameters) {
  ...
  public asConfigurationParameters(): SzDataMartConfigurationParameters {
    const retVal: SzDataMartConfigurationParameters = {};
  ...
  constructor(
    @Inject('DATAMART_ENVIRONMENT') readonly apiConfiguration: SzDataMartConfiguration,
